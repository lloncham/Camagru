...
$rep = $db->prepare('SELECT * FROM compte WHERE id=:id');
$rep->execute(Array(
    'id' => $_SESSION['id_user'],
));
$donnees = $rep->fetch();
                    ...
                    <div class="column is-8 is-offset-2">
                        <div class="card-content">
                            <div class="media">
                                ...
                                <p class="title is-1"><?php echo $donnees["identifiant"]?></p>
                                <p class="subtitle is-6"><?php echo $donnees["mail"]?></p>
                            </div>
                        </div>
                        <br/>
                        <label class="checkbox">
                            <input type="checkbox">
                            I wish to receive an e-mail when someone comment or like one of my picture
                        </label>
                        <br/>
                        <br/>
                        <p class="title is-4">Change your password: 
                            <form action="modif.php" method="POST">
                                <input type="hidden" name="mail" value="<?php echo $donnees["mail"]?>">
                                <input type="hidden" name="login" value="<?php echo $donnees["identifiant"]?>">
                                <div class="field">
                                ...
                                <div class="control">
                                    <button class="button is-primary" name="submit" value="OK">Change password</button>
                                </div>
                            </form>
                        </p>
                    </div>
